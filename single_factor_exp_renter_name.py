...
conversation_types = [
    "no-name-in-start",
    "name-from-origin-in-start",
    "name-origin-city-in-start",
]
conversation_type = "name-origin-city-in-start"
city = ["Mannheim", "New York", "Munich"]
...
max_rounds = (
    6  # maximum rounds in a conversation, where one round is one reply from a party
)
...
for variant in variants:
    variant_folder = (
        ...
        + "/"
        + variant[0][1]["name_id"]
    )  # create a folder with an experiment identifier and for each renter name
